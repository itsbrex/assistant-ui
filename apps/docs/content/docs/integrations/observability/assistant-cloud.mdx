...
The setup, three steps in `instrumentation.ts` and the chat route, the receiver's rules and the merge are on [Traces](/docs/cloud/traces); the runtime side is on [AI SDK + assistant-ui](/docs/cloud/ai-sdk-assistant-ui).
