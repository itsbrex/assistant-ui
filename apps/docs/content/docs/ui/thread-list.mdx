...
import { ThreadListSidebarSample } from "@/components/pages/docs/samples/thread-list/sidebar-composition";
import { ThreadListActiveSample } from "@/components/pages/docs/samples/thread-list/active-threads";
import { ThreadListNewSample } from "@/components/pages/docs/samples/thread-list/new-thread";
import { ThreadListArchiveSample } from "@/components/pages/docs/samples/thread-list/archive-thread";
...
<PreviewCode file="components/pages/docs/samples/thread-list/active-threads" name="ActiveThreadList">
...
<PreviewCode file="components/pages/docs/samples/thread-list/new-thread" name="EmptyThreadList">
  <ThreadListNewSample />
</PreviewCode>
...
<PreviewCode file="components/pages/docs/samples/thread-list/sidebar-composition" name="ThreadListSidebarDemo" className="p-0">
...
<PreviewCode file="components/pages/docs/samples/thread-list/archive-thread" name="ArchivableThreadList">
