...
The table has **Title**, **User** and **Updated** columns and loads 50 rows at a time. [Export](/docs/cloud/dashboard/exports) appears on plans that include exports.
...
|---|---|
| **Conversation** | The rendered transcript. |
