...
**Transfer project** and **Delete project** both continue through support. Transfer asks you to type the project name before it opens the support request. Delete asks you to type the project name and the literal `CONFIRM DELETE` before it opens the support request.
