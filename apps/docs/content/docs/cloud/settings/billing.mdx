...
**Billing** explains the plan's current period, active user allowance and projected use. **Usage** shows the period's activity and cost by day, model and user. Owners and admins can use **Upgrade** and **Open Stripe portal**. Every member can read project pages and open the pricing dialog from a plan badge.
...
**Upgrade**, shown to owners and admins when the organization has no active subscription, opens the pricing dialog. Choosing Pro opens the payment link. Choosing Startup or Enterprise books a call. The only plan change made inside the product is a downgrade to Free.

With an active subscription, the action is **Open Stripe portal**. The portal manages the subscription and is the place to cancel it. Only owners and admins can see the Billing header actions and use the portal. Every member can open the pricing dialog from a plan badge in **What the plan includes**. In the dialog, **Free** changes the project to Free, **Pro** opens the payment link, and **Startup** or **Enterprise** opens a call booking page.
...
Usage opens to the current month. **This billing period** says: `Active users are counted per UTC calendar month against the plan, whatever the range above.` Its **Active users** chart shows cumulative users, a dashed **On pace** line, and included and cap lines. The range presets are **This billing period** and **This month**. It includes the **What the plan includes** section from Billing.

The page has tiles for **Active users**, **Runs**, **Tokens** and **Cost**. Its charts are **Runs**, **Tokens**, **Cost**, **Cost by model, vs previous period** and **Cost concentration**. **Cloud features** separates **Thread titles on your plan** from **Thread titles on your key**. **By user** lists **User**, **Share**, **Runs**, **Tokens** and **Cost**. **User**, **Runs**, **Tokens** and **Cost** sort.
...
|---|---|---|
| **Upgrade** is not shown. | An active subscription shows **Open Stripe portal** instead. Only owners and admins see either Billing header action. | Ask an owner or admin to manage the plan through **Upgrade** or **Open Stripe portal**. |
