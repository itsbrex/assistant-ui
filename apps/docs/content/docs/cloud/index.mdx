...
| LangGraph, LangChain or Google ADK | Thread list, copied settled messages, feedback and engagement; the backend remains the transcript source, and `telemetry: { messages: false }` keeps copies out | [LangGraph, LangChain and ADK](/docs/cloud/langgraph) |
