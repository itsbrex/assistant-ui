...
| `400` | Plain text: `message_id must belong to thread_id` | The message is not in the supplied thread. |
| `404` | Plain text: `Thread not found` | The thread target is not available to the caller. |
| `404` | Plain text: `Run not found` | The run target is not available to the caller. |
