...
| `403` | Plain text: `This endpoint may only be accessed from the backend` | The credential was not an API key. |
...
| `403` | Plain text: `Invalid issuer format or projectId` | The request host does not identify a project. |
| `403` | Plain text: `Anonymous access is not allowed` | The project does not permit anonymous sessions. |
| `404` | Plain text: `Project not found` | The host identifies no live project. |
...
| `403` | Plain text: `Invalid refresh token format` | The token does not start with `refresh_0`. |
| `403` | Plain text: `Invalid refresh token` | No live anonymous token for an anonymous enabled project matches. |
| `403` | Plain text: `Invalid issuer format or projectId` | The request host does not identify a project. |
| `403` | Plain text: `Anonymous access is not allowed` | The project does not permit anonymous sessions. |
| `404` | Plain text: `Project not found` | The host identifies no live project. |
