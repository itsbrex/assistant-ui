...
| `props` | object | Optional. Keys are 1 to 64 characters. Each value is a string of at most 256 characters, a finite number, or a boolean. `JSON.stringify(props)` is at most 1,024 UTF-16 code units. |
