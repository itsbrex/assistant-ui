...
The Intelligence page also shows **Analysed**, **Junk**, **No reply**, **Loops**, **Unanswered**, and **Resolved** tiles. A thread's **Analysis** section shows its topic, task, phrasing, sentiment, resolution, language, turns, repeats, unanswered question, and whether it was classified.
...
| Model | No separate default | A model the selected provider lists | Selects the model used for classification. The server refuses a model that the provider does not list. |
