...
- **Functional Model Picker**: Fast / Grok 4.7 / Think dropdown with descriptions, plus "Subscribe to SuperGrok"
...
const MODELS = [
  ...
  { id: "grok-4.7", name: "Grok 4.7", description: "Standard reasoning", Icon: Moon },
