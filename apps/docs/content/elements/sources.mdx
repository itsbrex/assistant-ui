---
title: "Sources"
description: "Runtime URL sources with favicon, title, and an external link."
---
...
`Sources.Root` carries the styling; pass `variant` and `size` when composing your own renderer as above.
