...
declare const useExternalMessageConverter: <T extends WeakKey>(_param50: {
...
declare const useLocalRuntime: (chatModel: ChatModelAdapter, _param51?: LocalRuntimeOptions) => AssistantRuntime;
